package caojx.learn.netty.cn.itcast.netty.netty.advance.chat.client;

import caojx.learn.netty.cn.itcast.netty.netty.advance.chat.message.ChatRequestMessage;
...
import caojx.learn.netty.cn.itcast.netty.netty.advance.chat.message.GroupMembersRequestMessage;
...
import caojx.learn.netty.cn.itcast.netty.netty.advance.chat.message.PingMessage;
...
//                    ch.pipeline().addLast(LOGGING_HANDLER);
                    ...
                    // 3s（时间频率要比服务器稍微高一点） 内如果没有向服务器写数据，会触发一个 IdleState#WRITER_IDLE 事件
